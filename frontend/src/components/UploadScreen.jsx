...
function DropZone({ label, sublabel, icon, file, onDrop, color }) {
    ...
    const c = {
        indigo: { ring: 'rgba(99,102,241,0.5)', glow: 'rgba(99,102,241,0.12)', text: '#a5b4fc', rgb: '99,102,241' },
        violet: { ring: 'rgba(139,92,246,0.5)', glow: 'rgba(139,92,246,0.12)', text: '#c4b5fd', rgb: '139,92,246' },
    }[color]
    ...
    return (
        <div
            ...
            style={{
                ...
                padding: '32px 20px',
                background: isDragActive ? `rgba(${c.rgb},0.08)` : file ? 'rgba(16,185,129,0.05)' : 'rgba(255,255,255,0.02)',
            ...
            <div style={{ textAlign: 'center' }}>
                {file ? (
                    <>
                        ...
                        <div style={{ color: '#6ee7b7', fontFamily: 'Syne', fontWeight: 700, fontSize: 15, marginBottom: 5, wordBreak: 'break-all' }}>
                    ...
                    <>
                        ...
                        <div style={{ fontFamily: 'Syne', fontWeight: 700, color: '#e2e8f0', fontSize: 17, marginBottom: 6 }}>{label}</div>
                        <div style={{ color: 'rgba(148,163,184,0.65)', fontSize: 13, marginBottom: 12 }}>{sublabel}</div>
                        <div style={{
...
export default function UploadScreen() {
    ...
    return (
        <div style={{
            ...
            backgroundColor: '#050508', position: 'relative', overflow: 'hidden',
            backgroundImage: `
            ...
            <header style={{
                ...
                <div style={{
                    fontSize: 11, color: 'rgba(165,180,252,0.7)',
                    background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.2)',
                    borderRadius: 20, padding: '4px 12px', fontFamily: 'JetBrains Mono', fontWeight: 500,
                    whiteSpace: 'nowrap'
                }}>AI-Adaptive Onboarding Engine</div>
            </header>
            ...
            <main style={{
                ...
                <div style={{
                    ...
                    padding: isMobile ? '40px 20px 32px' : '56px 52px',
                    textAlign: 'center',
                    ...
                    <h1 style={{
                        ...
                        <br /><span style={{ color: 'rgba(226,232,240,0.85)' }}>Starts Here</span>
                    </h1>

                    {/* Description */}
                    <p style={{ color: 'rgba(148,163,184,0.75)', fontSize: 15, lineHeight: 1.8, maxWidth: 400, marginBottom: 36 }}>
                        Upload your resume and a job description. Our AI analyzes skill gaps and generates a prioritized roadmap in under 100 seconds.
                    </p>
                    ...
                    <div style={{
                        ...
                        {[
                            ...
                            <div key={title} style={{
                                ...
                                borderRadius: 12, padding: '11px 12px', textAlign: 'left',
                            }}>
                                <span style={{ fontSize: 18, flexShrink: 0 }}>{icon}</span>
                                <div style={{ minWidth: 0 }}>
                                    <div style={{ fontSize: 12, fontWeight: 600, color: '#e2e8f0', fontFamily: 'Syne' }}>{title}</div>
                ...
                <div style={{
                    ...
                    display: 'flex', flexDirection: 'column',
                    alignItems: 'center', justifyContent: 'center',
                    padding: isMobile ? '32px 20px 40px' : '56px 52px',
                }}>
                    <div style={{ width: '100%', maxWidth: 520, boxSizing: 'border-box' }}>

                        {/* Drop zones: stack on mobile, 2-col on desktop */}
                        <div style={{
                            display: 'grid',
                            ...
                            <div>
                                <div style={{ fontSize: 12, fontWeight: 600, color: 'rgba(165,180,252,0.7)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10, paddingLeft: 4 }}>
                                    01 · Your Resume
                                </div>
                                <DropZone label="Upload Resume" sublabel="Your work history & skills" icon="📄" file={resumeFile} onDrop={setResumeFile} color="indigo" />
                            </div>
                            <div>
                                <div style={{ fontSize: 12, fontWeight: 600, color: 'rgba(196,181,253,0.7)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10, paddingLeft: 4 }}>
                                    02 · Job Description
                                </div>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                fontSize: 17, fontFamily: 'Syne', fontWeight: 700, letterSpacing: '0.02em',
                                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10,
                                transition: 'all 0.3s ease',
                                background: canAnalyze ? 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 50%, #06b6d4 100%)' : 'rgba(255,255,255,0.05)',
                        ...
                        <p style={{ textAlign: 'center', marginTop: 14, fontSize: 13, color: 'rgba(148,163,184,0.45)' }}>
